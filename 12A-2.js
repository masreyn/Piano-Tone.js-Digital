...
// https://www.lynda.com/Ableton-Live-tutorials/Using-amp-envelope-shape-volume/428720/466104-4.html
...
// ampEnvelope
  ampEnvelope = new Tone.AmplitudeEnvelope({
    "attack": 0.1,
    "decay": 0.5, // 0.5,
    "sustain": 1.0, //(normal range 0.0 - 1.0)
    "release": 0.8,
  }).toMaster();
}
function draw () {
...
function keyPressed () {
  if (keyCode === 49) {
    ...
    poly.triggerAttackRelease(['C5', 'E4', 'G4'], 0.6);
  }
}
